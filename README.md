...
- 🐈 Useful GitHub Extensions: [**Refined GH**](https://addons.mozilla.org/en-US/firefox/addon/refined-github-/), [**Octotree**](https://addons.mozilla.org/en-US/firefox/addon/octotree/), [**NPMhub**](https://addons.mozilla.org/en-US/firefox/addon/npm-hub/), [**GH Repo Size**](https://addons.mozilla.org/en-US/firefox/addon/github-repo-size/), [**GH Dark The,e**](https://addons.mozilla.org/en-US/firefox/addon/github-dark-theme/), & [**GH File Icons**](https://addons.mozilla.org/en-US/firefox/addon/github-file-icon/)
